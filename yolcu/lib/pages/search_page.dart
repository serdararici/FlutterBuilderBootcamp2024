...
class _SearchTabState extends State<SearchTab> {
  ...
  final TextEditingController _dropofController = TextEditingController();
  final TextEditingController _pickupDateController = TextEditingController();
  final TextEditingController _dropofDateController = TextEditingController();
  ...
  void _validateAndShowResult() {
    if(isCarRentalSelected) {
      ...
      _dropofController.text.isEmpty ||
      _pickupDateController.text.isEmpty ||
      _dropofDateController.text.isEmpty) {
      ...
      body: Column(
        children: [
                        ...
                        child: Row(
                          children: [
                            Icon(
                              ...
                              color: isCarRentalSelected ? Colors.blue.shade800 : Colors.white,
                            ),
                            SizedBox(width: 8,),
                            Text(
                              'Araç Kiralama',
          ...
          Expanded(child: AnimatedSwitcher(duration: Duration(milliseconds: 300),
              child: isCarRentalSelected ? _buildCarRentalContent() : _buildFlightTicketContent(),
            ),
          ),
        ],
      ),
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  onTap: () => _selectDate(context, _dropofDateController),
                ),
              ),
            ],
          ),
